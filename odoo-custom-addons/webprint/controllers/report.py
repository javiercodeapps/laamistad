...
class ReportController(report.ReportController):
    ...
    @route()
    def report_download(self, data, context=None, token=None, other=None, other2=None,other3=None):
        resp = super().report_download(data, context, token, other=None, other2=None)
